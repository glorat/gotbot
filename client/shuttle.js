  ...
  return {
    ...
    controller: function ($scope) {
      ...
      vm.success = function () {
        ...
        return Math.floor(
          100 / (1 + Math.exp(-(vm.avgSkill / vm.difficulty - 0.5) * vm.magic))
        );
      };
      ...
      function shuttleSkill(shuttle, boost) {
        ...
        if (shuttle.type === 'single') {
          ...
          normalBase =
            +shuttle.base1 > +shuttle.base2
              ? +shuttle.base1 + 0.25 * shuttle.base2
              : +shuttle.base2 + 0.25 * shuttle.base1;
          // Let's have full boost if either matches
          if (
            shuttle.skill1 === boost.skill ||
            shuttle.skill2 === boost.skill
          ) {
