angular.module('myApp').controller('GotCtrl', function ($scope, $http, $sce) {
  var vm = this
    ...
    $http({
      ...
      function errorCallback(response) {
        ...
        vm.commandResult = {
          message: '',
          error:
            'The server was unable to process your request. The server may be down or your connection at fault',
        }
      }
    )
  }
