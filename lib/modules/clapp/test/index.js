  ...
  describe('#parseInput()', function () {
    ...
    it('should pass default values', function () {
      ...
      app.addCommand(
        new Clapp.Command({
          ...
          fn: function (argv) {
            passed =
              argv.args.testarg === 'defaultval' && argv.flags.testflag === 123
          },
          args: [
            {
              name: 'testarg',
    ...
    describe('async command handling', function () {
      describe('with Promise', function () {
        ...
        it(
          "shouldn't do anything if the fulfilled value is not string or object with" +
            ' string and context',
          function (done) {
    ...
    describe('data types parsing', function () {
      ...
      describe('number given', function () {
        ...
        describe('boolean asked', function () {
          ...
          it("shouldn't work if the number can't be converted to boolean", function () {
            let passed = false
  ...
  describe('#addCommand()', function () {
    ...
    it('should accept child instances of Command', function () {
      class MyCommand extends Clapp.Command {
        ...
        _getHelp(app) {
          return (
            'The command help for command "' + this.name + '" is overridden! D:'
          )
        }
      }
...
describe('Clapp.Command', function () {
  ...
  describe('error handling', function () {
    it('should throw an Error when given wrong options', function () {
      ...
      try {
        new Clapp.Command('foo', function () {}, {
    ...
    it('should throw an Error when given an argument or flag without description', function () {
      let thrown = []
...
describe('Clapp.Argument', function () {
  ...
  it(
    'should throw an error on type and default value mismatch, assuming that the argumnet is' +
      ' optional',
    function () {
      let thrown = []
