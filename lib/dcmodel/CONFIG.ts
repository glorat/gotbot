...
export default class CONFIG {
  ...
  static readonly CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT: {
    [index: number]: string
  } = {
  ...
  static readonly CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT: {
    [index: number]: string
  } = {
  ...
  static readonly STATS_CONFIG: {
    [index: number]: { symbol: string; skill: string; stat: string }
  } = {
    2: {
      symbol: 'engineering_skill_core',
      skill: 'engineering_skill',
      stat: 'core',
    },
    3: {
      symbol: 'engineering_skill_range_min',
      skill: 'engineering_skill',
      stat: 'range_min',
    },
    4: {
      symbol: 'engineering_skill_range_max',
      skill: 'engineering_skill',
      stat: 'range_max',
    },
    6: { symbol: 'command_skill_core', skill: 'command_skill', stat: 'core' },
    7: {
      symbol: 'command_skill_range_min',
      skill: 'command_skill',
      stat: 'range_min',
    },
    8: {
      symbol: 'command_skill_range_max',
      skill: 'command_skill',
      stat: 'range_max',
    },
    14: { symbol: 'science_skill_core', skill: 'science_skill', stat: 'core' },
    15: {
      symbol: 'science_skill_range_min',
      skill: 'science_skill',
      stat: 'range_min',
    },
    16: {
      symbol: 'science_skill_range_max',
      skill: 'science_skill',
      stat: 'range_max',
    },
    18: {
      symbol: 'diplomacy_skill_core',
      skill: 'diplomacy_skill',
      stat: 'core',
    },
    19: {
      symbol: 'diplomacy_skill_range_min',
      skill: 'diplomacy_skill',
      stat: 'range_min',
    },
    20: {
      symbol: 'diplomacy_skill_range_max',
      skill: 'diplomacy_skill',
      stat: 'range_max',
    },
    22: {
      symbol: 'security_skill_core',
      skill: 'security_skill',
      stat: 'core',
    },
    23: {
      symbol: 'security_skill_range_min',
      skill: 'security_skill',
      stat: 'range_min',
    },
    24: {
      symbol: 'security_skill_range_max',
      skill: 'security_skill',
      stat: 'range_max',
    },
    26: {
      symbol: 'medicine_skill_core',
      skill: 'medicine_skill',
      stat: 'core',
    },
    27: {
      symbol: 'medicine_skill_range_min',
      skill: 'medicine_skill',
      stat: 'range_min',
    },
    28: {
      symbol: 'medicine_skill_range_max',
      skill: 'medicine_skill',
      stat: 'range_max',
    },
  }
  ...
  static setLanguage(l: SupportedLanguage) {
    ...
    if (l === 'en') {
      ...
      this.SHIP_BATTLE_GRANT_DESC[16] =
        'Enemy shields become inoperable for a time'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[2] =
        'Immediately repairs Hull by %VAL%%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[3] =
        'Immediately repairs Shields by %VAL%%'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[8] =
        'Increases boarding damage by %VAL%%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[9] = 'Resets enemy cooldown timers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[10] =
        'Speeds up cooldown timers by %VAL% seconds'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[11] =
        'Decrease incoming hull damage by %VAL%%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[12] =
        '%VAL%% of incoming damage also taken by the attacker'

      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[0] =
        '+%VAL% to bonus boost'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[3] =
        '%VAL%% shield repair'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[6] =
        '+%VAL% shield regen.'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[7] =
        '+%VAL%% attack speed'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[8] =
        '%VAL%% boarding damage'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[9] =
        'Resets enemy cooldown timers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[10] =
        '+%VAL%s to cooldown timers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[11] =
        '-%VAL%% hull damage'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[12] =
        '%VAL%% reflection damage'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[3] =
        'Immediately Repairs Shields'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[9] =
        'Resets enemy cooldown timers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[10] = 'Speeds Up Cooldown Timers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[11] =
        'Decrease Incoming Hull Damage'
    ...
    // FRENCH
      ...
      this.SHIP_BATTLE_GRANT_DESC[4] =
        'Inflige des dégâts sur la durée à la coque ennemie'
      this.SHIP_BATTLE_GRANT_DESC[16] =
        'Les boucliers ennemis deviennent temporairement inopérants'

      this.CREW_SHIP_BATTLE_ABILITY_TYPE[0] = 'Augmente bonus boost de +%VAL%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[1] =
        'Inflige immédiatement %VAL% % de dégâts'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[2] =
        'Repare immédiatement %VAL% % de la coque'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[3] =
        'Repare immédiatement %VAL% % des boucliers'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[6] =
        '+%VAL% à la régénération des boucliers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[7] = "+%VAL% % à la vitesse d'attaque"
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[8] =
        "Augment %VAL% % de dégâts d'abordage"
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[9] =
        'Réinitialise les temps de recharge ennemis'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[10] =
        'Accélère les temps de recharge de %VAL% secondes'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[11] =
        'Réduit les dégâts de coque subis de %VAL% %'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[12] =
        "%VAL% % des dégâts subis sont aussi infligés à l'attaquant"

      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[0] =
        'bonus boost de +%VAL%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[1] = '%VAL%% dégâts'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[2] =
        '%VAL%% repare de la coque'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[3] =
        '%VAL%% repare des boucliers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[4] =
        '+%VAL% chance du critique'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[5] =
        '+%VAL% bonus critique'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[6] =
        '+%VAL% régén. des boucliers'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[7] =
        "+%VAL%% vitesse d'attaque"
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[8] =
        "%VAL%% dégâts d'abordage"
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[9] =
        "Réinitialise le recharge d'ennemis"
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[10] =
        '+%VAL%s au temps de recharge'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[11] =
        '-%VAL%% dégâts du coque'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[12] =
        '%VAL%% dégâts réflexion'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[2] =
        'Repare immédiatements de la coque'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[3] =
        'Repare immédiatements des boucliers'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[8] =
        "Augment de dégâts d'abordage"
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[9] =
        'Réinitialise les temps de recharge ennemis'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[10] =
        'Accélère les temps de recharge'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[11] =
        'Réduit les dégâts de coque'
    ...
    // GERMAN
      ...
      this.SHIP_BATTLE_GRANT_DESC[1] =
        'Erhöht deine Chance auf kritische Treffer'
      this.SHIP_BATTLE_GRANT_DESC[2] =
        'Das Schiff ist nicht anvisierbar werden kann'
      this.SHIP_BATTLE_GRANT_DESC[4] =
        'Verursacht DoT-Schaden an der Hülle des Feindes'
      this.SHIP_BATTLE_GRANT_DESC[16] =
        'Schilde sind für einen bestimmten Zeitraum inaktiv'

      this.CREW_SHIP_BATTLE_ABILITY_TYPE[0] = 'Erhöht den bonus boost um +%VAL%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[1] =
        'Verursacht sofort %VAL% % Schaden'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[2] =
        'Repariert die Hülle sofort um %VAL% %'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[3] =
        'Repariert die Schilde sofort um %VAL% %'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[7] =
        '+%VAL%% auf Angriffsgeschwindigkeit'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[8] =
        'Erhöht den Enterschaden auf %VAL%%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[9] =
        'Setzt feindliche Abklingzeiten zurück'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[10] =
        'Beschleunigt Abklingzeiten um %VAL% Sekunden'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[11] =
        'Reduziert den erlittenen Hüllenschaden um %VAL% %'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[12] =
        'Verursacht beim Angreifer %VAL% % des erlittenen Schadens'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[7] =
        '+%VAL%% Angriffsgeschwindigkeit'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[8] = '%VAL%% Enterschaden'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[9] =
        'Setzt feindliche Abklingzeiten zurück'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[10] =
        '+%VAL%s auf Abklingzeiten'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[11] =
        '-%VAL%% Hüllenschaden'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[12] =
        '%VAL%% Reflexionsschäden'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[9] =
        'Setzt feindliche Abklingzeiten zurück'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[10] =
        'Beschleunigt Abklingzeiten'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[11] =
        'Reduziert den erlittenen Hüllenschaden'
    ...
    // SPANISH
      ...
      this.SHIP_BATTLE_GRANT_DESC[1] =
        'Aumenta tu probabilidad de infligir daño crítico'
      this.SHIP_BATTLE_GRANT_DESC[2] =
        'Tu nave e impide que te marquen como objetivo'
      this.SHIP_BATTLE_GRANT_DESC[4] =
        'Inflige daño continuado al casco del enemigo'
      this.SHIP_BATTLE_GRANT_DESC[16] =
        'Los escudos enemigas quedan inoperativos durante un tiempo'

      this.CREW_SHIP_BATTLE_ABILITY_TYPE[0] = 'Aumenta bonus boost en +%VAL%'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[1] =
        'Inflige un %VAL% % de daño de forma inmediata'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[2] =
        'Repara el casco en un %VAL% % de forma inmediata'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[3] =
        'Repara los escudos en un %VAL% % de forma inmediata'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[4] = '+%VAL% de frecuencia de crítico'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[5] =
        '+%VAL% de bonificación de crítico'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[8] =
        'Aumenta el daño por abordaje de %VAL% %'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[9] =
        'Restablece los contadores de recarga de los enemigos'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[10] =
        'Acelera los contadores de recarga en %VAL% segundos'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[11] =
        'Reduce los daños del casco recibidos en un %VAL% %'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE[12] =
        'Un %VAL% % del daño recibido también se le inflige al atacante'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[8] =
        '%VAL%% daño abordaje'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[9] =
        'Restablece los contadores enemigos'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[10] =
        '+%VAL%s recarga contadores'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[11] =
        '-%VAL%% daños del casco'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT_FORMAT[12] =
        '%VAL%% daños de reflexión'
      ...
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[8] =
        'Aumenta el daño por abordaje'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[9] =
        'Restablece los contadores de recarga de los enemigos'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[10] =
        'Acelera los contadores de recarga'
      this.CREW_SHIP_BATTLE_ABILITY_TYPE_SHORT[11] =
        'Reduce los daños del casco'
